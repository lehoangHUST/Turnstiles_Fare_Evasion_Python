...
def display_body_parts(image, image_draw, coordinates, image_height=1024, image_width=1024, marker_radius=5):
    ...
    body_part_colors = ['#fff142', '#fff142', '#576ab1', '#5883c4', '#56bdef', '#f19718', '#d33592', '#d962a6',
                        '#e18abd', '#f19718', '#8ac691', '#a3d091', '#bedb8f', '#7b76b7', '#907ab8', '#a97fb9']
...
def display_segments(image, image_draw, coordinates, image_height=1024, image_width=1024, segment_width=5):
    ...
    segments = [(0, 1), (1, 5), (5, 2), (5, 6), (5, 9), (2, 3), (3, 4), (6, 7), (7, 8), (9, 10), (9, 13), (10, 11),
                (11, 12), (13, 14), (14, 15)]
    segment_colors = ['#fff142', '#fff142', '#576ab1', '#5883c4', '#56bdef', '#f19718', '#d33592', '#d962a6', '#e18abd',
                      '#f19718', '#8ac691', '#a3d091', '#bedb8f', '#7b76b7', '#907ab8', '#a97fb9']
...
def display_camera(cv2, frame, coordinates, frame_height, frame_width):
    ...
    segments = [(0, 1), (1, 5), (5, 2), (5, 6), (5, 9), (2, 3), (3, 4), (6, 7), (7, 8), (9, 10), (9, 13), (10, 11),
                (11, 12), (13, 14), (14, 15)]
    body_part_colors = [(66, 241, 255), (66, 241, 255), (177, 106, 87), (196, 131, 88), (239, 189, 86), (24, 151, 241),
                        (146, 53, 211), (166, 98, 217), (189, 138, 225), (24, 151, 241), (145, 198, 138),
                        (145, 208, 163), (143, 219, 190), (183, 118, 123), (184, 122, 144), (185, 127, 169)]
    ...
    for (a, b) in segments:
        ...
        if not (a_coordinate_x < 0 or a_coordinate_y < 0 or b_coordinate_x < 0 or b_coordinate_y < 0):
            cv2.line(frame, (a_coordinate_x, a_coordinate_y), (b_coordinate_x, b_coordinate_y),
                     color=body_part_colors[a], thickness=2)
...
def drawBinImage(image_draw, coordinates, image_height=1024, image_width=1024, segment_width=5, marker_radius=5):
    ...
    for i, (_, body_part_x, body_part_y) in enumerate(coordinates):
        ...
        body_part_y *= image_height
        image_draw.ellipse([(body_part_x - marker_radius, body_part_y - marker_radius),
                            (body_part_x + marker_radius, body_part_y + marker_radius)], fill=1)
