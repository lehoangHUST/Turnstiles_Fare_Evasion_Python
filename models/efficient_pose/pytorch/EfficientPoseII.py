...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.block2b_project_bn_res2_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                   ...
                                                                                   eps=0.0010000000474974513,
                                                                                   momentum=0.0)
        self.block2b_dwconv_res1_depthwise = self.__conv(2, name='block2b_dwconv_res1/depthwise', in_channels=192,
        ...
        self.block2c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block2c_dwconv_res1_depthwise = self.__conv(2, name='block2c_dwconv_res1/depthwise', in_channels=192,
                                                         out_channels=192, kernel_size=(3, 3), stride=(1, 1),
                                                         groups=192, bias=None)
        ...
        self.block2d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block2d_dwconv_res1_depthwise = self.__conv(2, name='block2d_dwconv_res1/depthwise', in_channels=192,
                                                         out_channels=192, kernel_size=(3, 3), stride=(1, 1),
                                                         groups=192, bias=None)
        ...
        self.block3a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block3a_dwconv_res1_depthwise = self.__conv(2, name='block3a_dwconv_res1/depthwise', in_channels=192,
                                                         out_channels=192, kernel_size=(5, 5), stride=(2, 2),
                                                         groups=192, bias=None)
        ...
        self.block3a_project_conv_res1_convolution = self.__conv(2, name='block3a_project_conv_res1/convolution',
                                                                 in_channels=192, out_channels=56, kernel_size=(1, 1),
                                                                 stride=(1, 1), groups=1, bias=None)
        ...
        self.block3b_expand_conv_res1_convolution = self.__conv(2, name='block3b_expand_conv_res1/convolution',
                                                                in_channels=56, out_channels=336, kernel_size=(1, 1),
                                                                stride=(1, 1), groups=1, bias=None)
        ...
        self.block3c_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block3c_dwconv_res1_depthwise = self.__conv(2, name='block3c_dwconv_res1/depthwise', in_channels=336,
                                                         out_channels=336, kernel_size=(5, 5), stride=(1, 1),
                                                         groups=336, bias=None)
        ...
        self.block3d_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block3d_dwconv_res1_depthwise = self.__conv(2, name='block3d_dwconv_res1/depthwise', in_channels=336,
                                                         out_channels=336, kernel_size=(5, 5), stride=(1, 1),
                                                         groups=336, bias=None)
        ...
        self.pass1_block1_mbconv1_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=80, out_channels=336,
        ...
        self.pass1_block1_mbconv1_skeleton_dconv1_depthwise = self.__conv(2,
                                                                          ...
                                                                          in_channels=336, out_channels=336,
                                                                          kernel_size=(5, 5), stride=(1, 1), groups=336,
                                                                          bias=None)
        ...
        self.pass1_block1_mbconv2_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=56, out_channels=336,
                                                                           kernel_size=(1, 1), stride=(1, 1), groups=1,
                                                                           bias=None)
        ...
        self.pass1_block1_mbconv3_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=112, out_channels=336,
                                                                           kernel_size=(1, 1), stride=(1, 1), groups=1,
                                                                           bias=None)
        ...
        self.pass1_block2_mbconv1_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=168, out_channels=336,
                                                                           kernel_size=(1, 1), stride=(1, 1), groups=1,
                                                                           bias=None)
        ...
        self.pass2_block1_mbconv1_detection1_conv1_convolution = self.__conv(2,
                                                                             ...
                                                                             in_channels=248, out_channels=336,
        ...
        self.pass3_detection2_confs_convolution = self.__conv(2, name='pass3_detection2_confs/convolution',
                                                              in_channels=168, out_channels=16, kernel_size=(1, 1),
                                                              stride=(1, 1), groups=1, bias=True)
    ...
    def forward(self, x):
        ...
        block2a_expand_conv_res2_convolution = self.block2a_expand_conv_res2_convolution(
            block1a_project_bn_res2_FusedBatchNorm_1)
        ...
        concatenate_2_concat = torch.cat(
            (pass1_block2_skip_skeleton_add, block3d_add_res1_add, block2b_project_bn_res2_FusedBatchNorm_1), 1)
        ...
        concatenate_3_concat = torch.cat(
            (pass2_block2_skip_detection1_add, block3d_add_res1_add, block2b_project_bn_res2_FusedBatchNorm_1), 1)
