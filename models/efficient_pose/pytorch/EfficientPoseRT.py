...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.stem_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2, 'stem_bn_res1/FusedBatchNorm_1',
                                                                        ...
                                                                        momentum=0.0)
        self.block1a_dwconv_res1_depthwise = self.__conv(2, name='block1a_dwconv_res1/depthwise', in_channels=32,
        ...
        self.block2a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block2a_dwconv_res1_depthwise = self.__conv(2, name='block2a_dwconv_res1/depthwise', in_channels=96,
        ...
        self.block2b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block2b_dwconv_res1_depthwise = self.__conv(2, name='block2b_dwconv_res1/depthwise', in_channels=144,
        ...
        self.block3a_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block3a_dwconv_res1_depthwise = self.__conv(2, name='block3a_dwconv_res1/depthwise', in_channels=144,
                                                         out_channels=144, kernel_size=(5, 5), stride=(2, 2),
                                                         groups=144, bias=None)
        ...
        self.block3b_expand_bn_res1_FusedBatchNorm_1 = self.__batch_normalization(2,
                                                                                  ...
                                                                                  eps=0.0010000000474974513,
                                                                                  momentum=0.0)
        self.block3b_dwconv_res1_depthwise = self.__conv(2, name='block3b_dwconv_res1/depthwise', in_channels=240,
                                                         out_channels=240, kernel_size=(5, 5), stride=(1, 1),
        ...
        self.pass1_block1_mbconv1_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=40, out_channels=240,
        ...
        self.pass1_block1_mbconv1_skeleton_dconv1_depthwise = self.__conv(2,
                                                                          ...
                                                                          in_channels=240, out_channels=240,
                                                                          kernel_size=(5, 5), stride=(1, 1), groups=240,
                                                                          bias=None)
        ...
        self.pass1_block1_mbconv3_skeleton_conv1_convolution = self.__conv(2,
                                                                           ...
                                                                           in_channels=80, out_channels=240,
                                                                           kernel_size=(1, 1), stride=(1, 1), groups=1,
                                                                           bias=None)
        ...
        self.pass2_block1_mbconv1_detection1_conv1_convolution = self.__conv(2,
                                                                             ...
                                                                             in_channels=160, out_channels=240,
        ...
        self.pass3_detection2_confs_convolution = self.__conv(2, name='pass3_detection2_confs/convolution',
                                                              in_channels=120, out_channels=16, kernel_size=(1, 1),
                                                              stride=(1, 1), groups=1, bias=True)
